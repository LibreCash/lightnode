...
//        this.onNodeUpdateRates(node, rates);
    ...
    onNodeConnected (node) {
        ...
        notifications.info('NODE_CONNECTED', {nodeId: node.id});
    ...
    onNodeDisconnected (node) {
        ...
        notifications.info('NODE_DISCONNECTED', {nodeId: node.id});
    ...
    onNodeUpdateRates (node, rates) {
        ...
        notifications.info('NODE_RATES_UPDATED', {nodeId: node.id});
    ...
    onContractEvent (error, event) {
        this.emit('notification', notification);
        
        notifications.info('CONTRACT_EVENT', {error, event});
