...
class Eth extends EventEmitter {
    ...
    init (options) {
        ...
        try {
            ...
            this.connect('web3', options.web3url, options.address, abiArray, options.updateTimeout);
            this.connect('infura', options.infuraUrl, options.address, abiArray, options.updateTimeout);
    ...
    async connect (name, url, address, abiArray, updateTimeout) {
        const options = {
            url,
            address,
            abiArray,
