...
class Eth extends EventEmitter {
    ...
    init (options, callback) {
        ...
        try {
            ...
            this.connect('web3', options.web3url, options.address, options.password, abiArray, options.updateTimeout);
            this.connect('infura', options.infuraUrl, options.address, options.password, abiArray, options.updateTimeout);
    ...
    async connect (name, url, address, password, abiArray, updateTimeout) {
        const options = {
            url,
            address,
            password,
