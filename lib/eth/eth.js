...
//    var web3Provider = new Web3.providers.HttpProvider(options.web3url);
    web3Provider.on('end', ()=>{
...
//        lastUpdateTime = await contract.methods.lastUpdateTime().call();
    ...
    var res = await contract.methods.setUpdaterAddress(options.from).call();
    res = await contract.methods.setBank(options.from).call();
